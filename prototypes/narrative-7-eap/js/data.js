...
EAP.structure = {
  ...
  children: [{
    ...
    children: [{
      ...
      children: [
        {id:'t1',name:'Auth Team',type:'team',spaces:['sp1','sp2','sp3']},
        {id:'t2',name:'Payments Team',type:'team',spaces:['sp4']},
...
// ═══════════════════════════════════════════════════════
// WORK ITEMS — Stories, Defects, Incidents, Problems
// ═══════════════════════════════════════════════════════
EAP.workItems = {
  // Backlog ranking: lower rank = higher priority. Realistic PM-ranked
  // interleave across Story / Defect / Incident / Problem, not bucket-by-type.
  backlog: {
    Story: [
    ...
    Incident: [
      {id:'blc1', num:'INC0070158', name:'Biometric fallback triggers HTTP 500 on edge-case PIN entry',               state:'Draft', pts:1, owner:'Ananya', team:'Auth Team',      type:'Incident', parent:'Fingerprint Login Redesign',      goal:'g1', rank:4},
      {id:'blc2', num:'INC0215264', name:'Fraud alert deduplication window too narrow — duplicates firing',            state:'Draft', pts:1, owner:'Aisha',  team:'Fraud Team',     type:'Incident', parent:'Real-time Fraud Alerts',          goal:'g1', rank:10},
      {id:'blc4', num:'INC0222243', name:'KYC compliance validation rejecting valid documents intermittently',          state:'Draft', pts:1, owner:'Ananya', team:'Onboarding Team',type:'Incident', parent:'Streamlined Onboarding Flow',    goal:'g2', rank:16},
      {id:'blc5', num:'INC0222244', name:'Biometric service unresponsive during peak authentication load',              state:'Draft', pts:2, owner:'Kiran',  team:'Auth Team',      type:'Incident', parent:'Fingerprint Login Redesign',      goal:'g1', rank:20},
      {id:'blc6', num:'INC0222245', name:'Statement export PDF fails silently on accounts with 100+ transactions',      state:'Draft', pts:1, owner:'Omar',   team:'Accounts Team',  type:'Incident', parent:'Account Statement Export PDF',    goal:'g2', rank:22}
    ],
    Problem: [
      {id:'prb1', num:'PRB0001234', name:'Fraud detection model accuracy degrades under sustained high transaction volume', state:'In Progress', pts:5, owner:'Marcus', team:'Fraud Team',      type:'Problem', parent:'Real-time Fraud Alerts',        goal:'g1', rank:2.5},
      {id:'prb4', num:'PRB0001237', name:'KYC document ingestion layer lacks retry logic and file size enforcement',        state:'Backlog',     pts:3, owner:'Devi',   team:'Onboarding Team', type:'Problem', parent:'Streamlined Onboarding Flow',  goal:'g2', rank:3.5},
      {id:'prb2', num:'PRB0001235', name:'Auth token lifecycle management causes cascading session failures at scale',      state:'In Progress', pts:3, owner:'James',  team:'Auth Team',       type:'Problem', parent:'Fingerprint Login Redesign',    goal:'g1', rank:11.5},
      {id:'prb3', num:'PRB0001236', name:'Android background process restrictions cause unreliable push notification delivery', state:'Backlog', pts:2, owner:'Tomás',  team:'Mobile Exp Team', type:'Problem', parent:'Real-time Fraud Alerts',        goal:'',   rank:21.5}
    ]
  },
  sprints: [
    {id:'sp2', name:'Sprint 2', dates:EAP._sprintDisplay[1].dates, active:true, capPct:81, totalPts:84, donePts:15, goal:'Deliver PIN fallback handler and biometric onboarding scaffold',
      items: [
        ...
        // Defects, Incidents and Problems in flight this sprint (realistic mix, not 100% Stories)
        ...
        {id:'blc3', num:'INC0222242',   name:'Payment API gateway returning intermittent 504 timeouts on confirmation step', type:'Incident',  state:'In Progress', pct:50, pts:2, owner:'Mei',    team:'Payments Team',  blocked:true, blockReason:'Auth API contract not yet finalised by Auth Team', parent:'Payment Confirmation Flow',  goal:'g1'},
...
// ═══════════════════════════════════════════════════════
// SPACES — Team-owned workspaces for ad-hoc work
// Each space defines: id, name, team, tabs (enabled tabs),
// defaultTab, and the data for each tab.
// ═══════════════════════════════════════════════════════
EAP.spaces = {

  // ── sp1: Auth Team — Retrospective ───────────────────
  sp1: {
    id: 'sp1',
    name: 'Retrospective',
    team: 't1',
      ...
      columns: [
        {
          ...
          cards: [
            { id: 'r1', text: 'OAuth 2.0 PKCE flow shipped on time — no slippage into Sprint 3', author: 'Kiran' },
            { id: 'r2', text: 'Strong collaboration with Mobile Exp Team on biometric handshake design', author: 'Sana' },
            { id: 'r3', text: 'Zero production incidents across Sprint 2 — best run this PI', author: 'James' },
            { id: 'r4', text: 'Async retro pre-fill meant we spent 20 min less on gathering, more on actions', author: 'Kiran' }
          ]
        },
        {
          id: 'improve', label: 'Should Improve', color: '#D97706',
          cards: [
            { id: 'r5', text: 'Token refresh edge cases caught in QA, not unit tests — shift left on coverage', author: 'James' },
            { id: 'r6', text: 'API docs lagging behind implementation — consumers blocked for 3 days', author: 'Sana' },
            { id: 'r7', text: 'Safari private mode bug slipped through — need cross-browser gate in CI', author: 'Kiran' }
          ]
        },
        {
          id: 'actions', label: 'Action Items', color: '#6366F1',
          cards: [
            { id: 'r8',  text: 'Add token expiry + edge case test suite before Sprint 3 kick-off', author: 'Kiran' },
            { id: 'r9',  text: 'Update OAuth PKCE API docs — target: end of Sprint 3 week 1', author: 'Sana' },
            { id: 'r10', text: 'Add Safari private mode to browser matrix in CI pipeline', author: 'James' }
          ]
        },
        {
          id: 'done', label: 'Done', color: '#9CA3AF',
          cards: [
            { id: 'r11', text: 'Moved standup to 09:30 — resolved cross-team scheduling overlap', author: 'James' },
            { id: 'r12', text: 'Retrospective format updated to async pre-fill — agreed last retro', author: 'Sana' }
          ]
        }
      ]
    }
  ...
  // ── sp3: Auth Team — Meeting Notes & Actions ─────────
  sp3: {
    id: 'sp3',
    name: 'Meeting Notes',
    team: 't1',
      ...
      columns: [
        {
          ...
          cards: [
            { id: 'a1', text: 'Review Redis session store capacity with Infra Team', author: 'James',  source: 'Architecture Review — May 20' },
            { id: 'a2', text: 'Send biometric launch pre-brief to Lisa Chen (CISO)',  author: 'Kiran',  source: 'Stakeholder Sync — May 22' }
          ]
        },
        {
          id: 'in-progress', label: 'In Progress', color: '#D97706',
          cards: [
            { id: 'a3', text: 'Update sprint 2 commitment doc after scope reduction', author: 'Sana', source: 'Sprint 2 Planning — May 14' }
          ]
        },
        {
          id: 'done', label: 'Done', color: '#9CA3AF',
          cards: [
            { id: 'a4', text: 'Document OAuth PKCE architecture decision',      author: 'James', source: 'Architecture Review — May 20' },
            { id: 'a5', text: 'Share Sprint 1 retro actions with SM',           author: 'Kiran', source: 'Team Retro — May 7' },
            { id: 'a6', text: 'Circulate async retro template to team',         author: 'Sana',  source: 'Team Retro — May 7' }
          ]
        }
      ]
    }
  ...
  // ── sp4: Payments Team — one space (shows chevron) ───
  sp4: {
    id: 'sp4',
    name: 'Payment Runbooks',
    team: 't2',
