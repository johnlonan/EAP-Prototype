...
EAP.workItems = {
  ...
  sprints: [
    {id:'sp2', name:'Sprint 2', dates:EAP._sprintDisplay[1].dates, active:true, capPct:81, totalPts:84, donePts:15, goal:'Deliver PIN fallback handler and biometric onboarding scaffold',
      items: [
        {id:'ls6',  num:'STRY61094201', name:'Handle fallback to PIN on failed biometric scan',     type:'Story',     state:'In Progress', pct:50, pts:3, owner:'James',  team:'Auth Team',     parent:'Fingerprint Login Redesign', goal:'g1', pr:{branch:'feature/pin-fallback-handler', number:1247, status:'open'}},
        ...
        {id:'ls9',  num:'STRY61094204', name:'Payment amount validation rules and error states',    type:'Story',     state:'In Review',   pct:80, pts:3, owner:'Vikram', team:'Payments Team', parent:'Payment Confirmation Flow', goal:'g1', pr:{branch:'feature/payment-validation-rules', number:4291, status:'merged'}},
        ...
        {id:'ls12', num:'STRY61094207', name:'Auth session expiry handler and token refresh',       type:'Story',     state:'In Progress', pct:45, pts:3, owner:'Sana',   team:'Auth Team',     parent:'Fingerprint Login Redesign', goal:'g1', pr:{branch:'feature/auth-session-expiry', number:1251, status:'open'}},
        ...
        {id:'bld6', num:'DEF0500643',   name:'Auth token refresh fails silently after 24h session',           type:'Defect',    state:'In Progress', pct:60, pts:3, owner:'Sana',   team:'Auth Team',      parent:'Fingerprint Login Redesign', goal:'g1', pr:{branch:'fix/auth-token-silent-fail', number:1244, status:'open'}},
        ...
        {id:'ls27', num:'STRY61094222', name:'Build biometric onboarding for new users',                       type:'Story',     state:'In Progress', pct:25, pts:5, owner:'James',  team:'Auth Team',      parent:'Enhanced Biometric Auth Flow', goal:'g1', pr:{branch:'feature/biometric-onboarding', number:1253, status:'open'}},
        ...
        {id:'ls33', num:'STRY61094228', name:'Statement export PDF layout and template scaffolding',           type:'Story', state:'In Progress', pct:30, pts:4, owner:'Lena',  team:'Accounts Team',    parent:'Account Statement Export PDF',   goal:'g2', pr:{branch:'feature/statement-export-layout', number:1248, status:'open'}},
          ...
          {id:'c1', type:'capability', name:'Seamless Authentication', state:'In Progress', pct:65, pts:10, owner:'Ananya', team:'Auth',
            children: [
              {id:'f1', type:'feature', name:'Fingerprint Login Redesign', state:'In Progress', pct:65, pts:18, owner:'Ananya', team:'Auth',
                children: [
                  {id:'s1', type:'story', name:'Build biometric prompt UI', state:'Done', pct:100, pts:5, owner:'Kiran', team:'Auth', pr:{branch:'feature/biometric-prompt-ui', number:1198, status:'merged'}},
