...
EAP.renderHierarchy = function() {
  ...
  var h = '<div class="gpanel" style="flex:1;min-width:0;">' +
    ...
    '<span style="font-size:11px;color:#6B7280;margin-left:8px;">' + captionForGrouping(grouping) + '</span></div>' +
  ...
  var typeColors = { goal:'#374151', epic:'#6d28d9', capability:'#0369a1', feature:'#2563EB', story:'#8B5CF6', defect:'#DC2626',
                     ...
                     size:'#475569', risk:'#dc2626', art:'#1d4ed8', st:'#0e4e69' };
  ...
  rows.forEach(function(r, idx) {
    ...
    var rowStyle = isTop
      ? 'background:linear-gradient(135deg, rgba(140,215,180,0.10), rgba(140,195,220,0.10));border-left:3px solid var(--color-primary);border-bottom:1px solid rgba(14,78,105,0.10);box-shadow:inset 0 1px 0 rgba(255,255,255,0.55);'
      : isE ? 'background:rgba(14,78,105,0.02);' : '';
