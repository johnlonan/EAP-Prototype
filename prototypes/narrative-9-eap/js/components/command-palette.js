  ...
  function buildCommands() {
    ...
    if (isApp()) {
      return [
        ...
        { label: 'Go to Kanban',             cat: 'Navigate', kw: 'board kanban go',             ico: ICON_NAV,    cls: '',          fn: function () { EAP.setTab('board'); } },
        { label: 'Go to Sprint Board',       cat: 'Navigate', kw: 'sprint task track go',        ico: ICON_NAV,    cls: '',          fn: function () { EAP.setTab('board'); EAP.setKanbanView('sprint'); } },
        { label: 'Go to Analytics',          cat: 'Navigate', kw: 'analytics go',                ico: ICON_NAV,    cls: '',          fn: function () { EAP.setTab('analytics'); } },
    ...
    return [
      ...
      { label: 'Open Kanban',               cat: 'Navigate', kw: 'board kanban open go',   ico: ICON_NAV,  cls: '', fn: function () { window.location.href = 'index.html?p=' + p + '&tab=board'; } },
      { label: 'Open Sprint Board',        cat: 'Navigate', kw: 'sprint task track open', ico: ICON_NAV,  cls: '', fn: function () { window.location.href = 'index.html?p=' + p + '&tab=board&kv=sprint'; } },
      { label: 'Open Analytics',           cat: 'Navigate', kw: 'analytics open go',      ico: ICON_NAV,  cls: '', fn: function () { window.location.href = 'index.html?p=' + p + '&tab=analytics'; } },
